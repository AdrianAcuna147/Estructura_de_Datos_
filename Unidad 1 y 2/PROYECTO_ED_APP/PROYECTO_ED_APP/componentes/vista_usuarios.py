                    ...
                    rx.vstack(
                        ...
                        rx.hstack(
                            ...
                            rx.input(
                                ...
                                value=ContableState.usuarios_texto_busqueda,
                                on_change=ContableState.set_usuarios_texto_busqueda,
                                width="100%",
                                bg="#1A202C",
                                color="white",
                        ...
                        rx.cond(
                            ContableState.total_usuarios_filtradores == 0,
                            rx.center(
                                rx.vstack(
                            ...
                            rx.box(
                                rx.table.root(
                                    ...
                                    rx.table.body(
                                        rx.foreach(
                                            ContableState.usuarios_paginados,
                                ...
                                bg="#141921", border="1px solid #2D3748",
                                border_radius="20px", padding="1.5em",
                        ...
                        rx.cond(
                            ...
                            rx.hstack(
                                rx.button(
                                    ...
                                    "Anterior",
                                    on_click=ContableState.usuarios_pagina_anterior,
                                    is_disabled=ContableState.usuarios_pagina_actual == 1,
                                    size="1", variant="outline",
                                ),
                                rx.box(
                                    rx.cond(
                                        ContableState.total_paginas_usuarios == 0,
                                        rx.text("Página 1 de 1", color="#718096", size="1"),
                                        rx.text(
                                            f"Página {ContableState.usuarios_pagina_actual} de {ContableState.total_paginas_usuarios} | {ContableState.total_usuarios_filtradores} usuarios",
                                            color="#718096",
                                            size="1"
                                        ),
                                    ),
                                ...
                                rx.button(
                                    ...
                                    on_click=ContableState.usuarios_pagina_siguiente,
                                    is_disabled=ContableState.usuarios_pagina_actual >= ContableState.total_paginas_usuarios,
                                    size="1", variant="outline",
                                ),
                                width="100%", justify="center", spacing="3", align="center",
                            ),
                        ),
                    ),
                    value="lista",
                    ...
                    rx.vstack(
                        ...
                        rx.box(
                            rx.vstack(
                                ...
                                # Fila 4: Domicilio + Edad
                                rx.hstack(
                                    rx.vstack(
                                        rx.text("Domicilio", color="#718096", size="1"),
                                        rx.input(
                                            placeholder="Calle, número, ciudad...",
                                            value=ContableState.reg_domicilio,
                                            on_change=ContableState.set_reg_domicilio,
                                            bg="#2D3748", color="#FFFFFF", border="none", width="100%",
                                        ),
                                        width="100%", spacing="1",
                                    ),
                                    rx.vstack(
                                        ...
                                        rx.input(
                                            placeholder="Edad",
                                            type="number",
                                            value=ContableState.reg_edad.to(str),
                                            on_change=ContableState.set_reg_edad,
                                            bg="#2D3748", color="#FFFFFF", border="none", width="110px",
                                        ),
                                        spacing="1",
                                    ),
                                    spacing="3", width="100%",
                                ...
                                rx.text("* Campos obligatorios", color="#4A5568", size="1"),
