        ...
        rx.vstack(
            rx.hstack(
                ...
                rx.text(
                    ...
                    weight="bold",
                    color="#0E4EA1",
                    white_space="nowrap",      # ← No hace salto de línea
            ...
            rx.box(
                rx.vstack(
                    ...
                    rx.grid(
                        tarjeta_metrica(
                                        "Ingresos",
                                        "$" + ContableState.total_ingresos.to(str),
                                        "trending-up",
                                        "#1C2D24",
                                        "#48BB78"
                                        ),
                        tarjeta_metrica(
                                        "Egresos",
                                        "$" + ContableState.total_egresos.to(str),
                                        "trending-down",
                                        "#2D1C1C",
                                        "#F56565"
                                        ),
                        tarjeta_metrica(
                                        "Saldo",
                                        "$" + ContableState.saldo_total.to(str),
                                        "wallet",
                                        "#1C252D",
                                        "#4299E1"
                                        ),
