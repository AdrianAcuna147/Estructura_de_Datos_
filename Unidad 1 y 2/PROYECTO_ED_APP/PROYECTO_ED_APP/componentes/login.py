...
def vista_login() -> rx.Component:
    return rx.center(
        rx.vstack(
            ...
            # CARD DE LOGIN
            #Titulos que aparecen al principio
            rx.box(
                rx.vstack(
                    rx.vstack(
                    ...
                    # CAMPO NOMBRE
                    # En este esta el input que llama la funcion para poner el nombre
                    rx.vstack(
                        rx.hstack(
                    ...
                    # CAMPO CONTRASEÑA con botón ojo (para ver lo que se escribe)
                    rx.vstack(
                        rx.hstack(
                        ...
                        rx.box(
                            #Aqui entra la contraseña y la encripta en la base de datos 
                            rx.input(
            ...
            rx.text(
                "Estructura de Datos 3SA — Equipo 2",
                color="#4A5568",
                size="1",
                margin_top="1em",
            ),
...
# La ventana que aparece para recuperar la contraseña
# Aqui se conecta email_config.py
        ...
        rx.dialog.content(
            ...
            rx.cond(
                ...
                rx.vstack(
                    ...
                    # Aqui se escribe el correo donde se enviara el codigo de verificacion y cambiar de contraseña
                    rx.input(
                ...
                rx.cond(
                    ...
                    rx.vstack(
                        ...
                        rx.vstack(
                            # Input del codifo de verificacion
                        ...
                        rx.vstack(
                            ...
                            # Input para ingresar nueva contraseña y se reemplazara la anterior con que esta en la base de datos
                            rx.input(
